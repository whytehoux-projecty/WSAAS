...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect to E-Banking Portal with token
            const portalUrl = process.env.NEXT_PUBLIC_PORTAL_URL || 'http://localhost:4000';
            window.location.href = `${portalUrl}/dashboard?token=${encodeURIComponent(data.accessToken)}`;
        } catch (error) {
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="text-center pt-4 border-t border-faded-gray-light">
                                <p className="text-sm text-charcoal-light">
                                    ...
                                    <Link href="/signup" className="text-vintage-green hover:text-vintage-green-dark font-semibold transition-colors">
